/**
 * Ce script corrige uniquement la fonction displayFinancialInfo dans pappers-essentiel.js
 */
const fs = require('fs');
...
fs.readFile(scriptPath, 'utf8', (err, data) => {
  ...
  // Fonction displayFinancialInfo corrigée
...
function displayFinancialInfo(data) {
  ...
  fs.writeFile(scriptPath, correctedContent, 'utf8', (err) => {
    ...
    console.log('La fonction displayFinancialInfo a été corrigée avec succès dans pappers-essentiel.js.');
  });
});
