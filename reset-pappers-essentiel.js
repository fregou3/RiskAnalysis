...
fs.readFile(scriptPath, 'utf8', (err, data) => {
  ...
  // Définir la fonction displayFinancialInfo correcte
  const correctDisplayFinancialInfo = `/**
...
function displayFinancialInfo(data) {
  ...
  const correctedContent = data.replace(displayFinancialInfoRegex, correctDisplayFinancialInfo + '\n\n');
  ...
  fs.writeFile(scriptPath, correctedContent, 'utf8', (err) => {
    ...
    console.log('Le fichier pappers-essentiel.js a été réinitialisé avec une version correcte de la fonction displayFinancialInfo.');
  });
});
